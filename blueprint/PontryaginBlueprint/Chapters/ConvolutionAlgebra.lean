...
:::definition "mconv_def" (parent := "l1_algebra") (lean := "mconv, mstar")
...
:::theorem "mconv_comm" (parent := "l1_algebra") (lean := "mconv_comm")
...
:::theorem "mconv_assoc" (parent := "l1_algebra") (lean := "mconv_assoc")
...
:::theorem "mconv_norm" (parent := "l1_algebra") (lean := "integral_norm_mconv_le")
...
:::theorem "dense_cc_submodule" (parent := "l1_algebra") (lean := "dense_ccSubmodule")
...
:::definition "l1_mul" (parent := "l1_algebra") (lean := "mulCLM")
...
:::definition "l1_algebra_def" (parent := "l1_algebra") (lean := "L1G")
...
:::theorem "approx_identity" (parent := "l1_algebra") (lean := "L1G.exists_bump_mul_close")
